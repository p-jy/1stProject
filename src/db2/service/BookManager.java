...
public class BookManager {
    ...
    // BookManager 생성자에 BookDAOImpl을 인자로 받음
    public BookManager(BookDAOImpl bookDao) {
        if (bookDao == null) {
            this.bookDao = new BookDAOImpl();  // 기본 생성자로 초기화
        } else {
            this.bookDao = bookDao; // 주입된 BookDAOImpl 사용
        }
