...
CREATE TABLE `MEMBER` (
    ...
    `ME_NUM` VARCHAR(11) UNIQUE NOT NULL,
...
-- 외래키 제약 
ALTER TABLE `RENT` ADD CONSTRAINT `FK_MEMBER_TO_RENT_1` FOREIGN KEY (`RE_ME_ID`)
REFERENCES `MEMBER` (`ME_ID`);

ALTER TABLE `RENT` ADD CONSTRAINT `FK_BOOK_TO_RENT_1` FOREIGN KEY (`RE_BO_CODE`)
REFERENCES `BOOK` (`BO_CODE`);

ALTER TABLE `BOOK` ADD CONSTRAINT `FK_CATEGORY_TO_BOOK_1` FOREIGN KEY (`BO_CA_NUM`)
